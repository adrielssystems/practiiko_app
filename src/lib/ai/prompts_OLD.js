/**
 * PROMPTS DEL AGENTE VIRTUAL (PRACTIIKO) - RESPALDO VERSION v4.5
 */
...
* REGLA ESTRICTA: NUNCA utilices emojis o emoticonos en tus respuestas. Está strictly prohibido usar emojis.
